      ...
      <div className="flex gap-2">
        {account.is_active ? (
          ...
          <button
            ...
            title={
              switchDisabled
                ? "Close standalone Codex CLI processes first"
                : "Switch account and restart supported Codex apps automatically"
            }
          >
            {switching ? "Switching..." : switchDisabled ? "CLI Running" : "Switch & Restart"}
          </button>
        )}
        <button
          onClick={() => {
